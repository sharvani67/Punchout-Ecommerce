...
//         console.log("Product data:", data); // Debug log to see what's coming
//         setProduct(data);
//       } catch (err) {
...
//             <div className="space-y-6">
//               <div>
//                 {/* CATEGORY - NOW DISPLAYING PROPERLY */}
...
//                           <p className="text-gray-800 font-medium">{product.category_name || '—'}</p>
//                         </div>
//                         <div>
...
//               {/* PDF DOWNLOAD - ADDED LIKE ADMIN PAGE */}
