...
//           <Button
//             onClick={handleLogout}
//             className="flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white font-semibold px-5 py-2 rounded-xl shadow-lg transition-all duration-300 hover:scale-105"
//           >
//             <LogOut size={18} />
//             Logout
//           </Button>
...
//           <Button
//             onClick={handleLogout}
//             className="mt-2 flex items-center justify-center gap-2 bg-red-500 hover:bg-red-600 text-white font-semibold py-3 rounded-xl shadow-lg transition-all duration-300"
//           >
//             <LogOut size={18} />
//             Logout
//           </Button>
...
export default function AdminNavbar() {
  ...
  // PRODUCTS ACTIVE - Added product details page
  const isProductsActive =
    location.pathname === '/admin/productstable' ||
    location.pathname.startsWith('/admin/add-product') ||
    location.pathname.startsWith('/admin/edit-product') ||
